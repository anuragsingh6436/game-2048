...
@Composable
fun Game2048Theme(
    themeMode: com.bajrangi.game_2048.domain.model.ThemeMode =
        com.bajrangi.game_2048.domain.model.ThemeMode.SYSTEM,
    content: @Composable () -> Unit
) {
    val darkTheme = when (themeMode) {
        com.bajrangi.game_2048.domain.model.ThemeMode.LIGHT -> false
        com.bajrangi.game_2048.domain.model.ThemeMode.DARK -> true
        com.bajrangi.game_2048.domain.model.ThemeMode.SYSTEM -> isSystemInDarkTheme()
    }
